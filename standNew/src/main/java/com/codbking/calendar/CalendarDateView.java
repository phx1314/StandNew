    ...
    public void init() {
        ...
        setAdapter(new PagerAdapter() {
            ...
            public Object instantiateItem(ViewGroup container, final int position) {
                dateArr = CalendarUtil.getYMD(mDate);
                CalendarView view;
                if (!cache.isEmpty()) {
                ...
                view.setData(getMonthOfDayList(dateArr[0], dateArr[1] + position - MAX / 2), position == MAX / 2, mDate);
                selectPostion = -1;
        ...
        addOnPageChangeListener(new OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                if (onItemClickListener != null) {
                    ...
                    onItemClickListener.onItemClick((View) obs[0], (int) obs[1], (CalendarBean) obs[2], false, isFromUser);
                }
