...
public class UpdateNameActivity extends BaseApiActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (getIntent() != null) {
			...
			mNewName.setSelection(getIntent().getStringExtra("USERNAME")
					.length());
		}
	}
		...
		if (item.getItemId() == R.id.icon) {
			...
			if (!TextUtils.isEmpty(mNewName.getText().toString())) {
				...
				httpRequest = DemoContext.getInstance().getDemoApi()
						.updateProfile(mNewName.getText().toString(), this);
