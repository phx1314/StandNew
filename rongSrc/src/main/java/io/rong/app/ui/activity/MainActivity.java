...
public class MainActivity extends BaseActivity implements View.OnClickListener,
	...
	private void getConversationPush() {
		if (getIntent() != null
				&& getIntent().hasExtra("PUSH_CONVERSATIONTYPE")
				&& getIntent().hasExtra("PUSH_TARGETID")) {

			final String conversationType = getIntent().getStringExtra(
					"PUSH_CONVERSATIONTYPE");
	...
	private void getPushMessage() {
		...
		if (intent != null && intent.getData() != null
			...
			Log.e("RongPushActivity", "--content--" + content + "--data--"
					+ data + "--id--" + id);
			if (RongIM.getInstance() != null
					&& RongIM.getInstance().getRongIMClient() != null) {
			...
			if (DemoContext.getInstance() != null) {
				...
				if (token.equals("default")) {
					...
					if (RongIM.getInstance() != null
							&& RongIM.getInstance().getRongIMClient() != null) {
						RongIMClient.ConnectionStatusListener.ConnectionStatus status = RongIM
								.getInstance().getRongIMClient()
								.getCurrentConnectionStatus();
						if (RongIMClient.ConnectionStatusListener.ConnectionStatus.CONNECTED
								.equals(status)) {
							return;
						} else if (RongIMClient.ConnectionStatusListener.ConnectionStatus.CONNECTING
								.equals(status)) {
							return;
						} else {
	...
	private class DemoFragmentPagerAdapter extends
		...
		public Fragment getItem(int i) {
			...
			switch (i) {
			case 0:
				mMainConversationTv.setTextColor(getResources().getColor(
						R.color.de_title_bg));
	...
	private void selectNavSelection(int index) {
		...
		case 0:
			...
			break;
		case 1:
			mMainGroupTv.setTextColor(getResources().getColor(
					R.color.de_title_bg));
			...
			break;
		case 2:
			mMainChatroomTv.setTextColor(getResources().getColor(
					R.color.de_title_bg));
			...
			break;
		case 3:
			mMainCustomerTv.setTextColor(getResources().getColor(
					R.color.de_title_bg));
			TranslateAnimation animation3 = new TranslateAnimation(
					3 * indicatorWidth, indicatorWidth * 3, 0f, 0f);
	...
	public void onClick(View v) {
		if (v.getId() == R.id.main_conversation_liner) {
			mViewPager.setCurrentItem(0);
		} else if (v.getId() == R.id.main_group_liner) {
			mViewPager.setCurrentItem(1);
		} else if (v.getId() == R.id.main_chatroom_liner) {
			mViewPager.setCurrentItem(2);
		} else if (v.getId() == R.id.main_customer_liner) {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		if (hasNewFriends) {
			...
			mMenu.getItem(0)
					...
					.setIcon(
							getResources().getDrawable(
									R.drawable.de_btn_main_contacts_select));
		} else {
			mMenu.getItem(0).setIcon(
					getResources().getDrawable(R.drawable.de_ic_add));
			mMenu.getItem(0)
					.getSubMenu()
					.getItem(1)
					.setIcon(
							getResources().getDrawable(
									R.drawable.de_btn_main_contacts));
		}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		if (item.getItemId() == R.id.add_item1) {
			startActivity(new Intent(this, FriendListActivity.class));
		} else if (item.getItemId() == R.id.add_item3) {
			startActivity(new Intent(MainActivity.this, ContactsActivity.class));
		} else if (item.getItemId() == R.id.set_item1) {
			startActivity(new Intent(MainActivity.this, MyAccountActivity.class));
		} else if (item.getItemId() == R.id.set_item2) {
			startActivity(new Intent(MainActivity.this,
					NewMessageRemindActivity.class));
		} else if (item.getItemId() == R.id.set_item3) {
			startActivity(new Intent(MainActivity.this, PrivacyActivity.class));
		} else if (item.getItemId() == R.id.set_item4) {
			startActivity(new Intent(MainActivity.this,
					AboutRongCloudActivity.class));
		} else if (item.getItemId() == R.id.set_item5) {
			...
			alterDialog.setPositiveButton("确定",
					new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							if (RongIM.getInstance() != null) {
								if (DemoContext.getInstance() != null) {
									SharedPreferences.Editor edit = DemoContext
											.getInstance()
											.getSharedPreferences().edit();
									edit.putString(Constants.APP_TOKEN,
											Constants.DEFAULT);
									edit.apply();
								}
