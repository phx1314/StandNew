...
//                            mListViewListener.onRefresh();
    ...
    public void loadData(boolean isRefreash) {
        if (type.equalsIgnoreCase("POST")) {
            if (obj != null) {
                loadUrlPostBase(method, isRefreash, obj, PageSize_key, PageSize + "", PageIndex_key, PageIndex + "", mparams);
            } else {
...
//        stopLoadMore();
    ...
    public void setPostApiLoadParamsBase(String method, Object obj, Object... mparams) {
